...
const membershipPlans: MembershipPlan[] = [
  {
    name: "8-Week Boxing Reset",
    price: "$197",
    period: "one-time",
    description: "Structured beginner-friendly boxing and fitness transformation in 8 weeks",
    features: ["3 guided workouts per week", "Unlisted YouTube training library", "Weekly progress checkpoints", "Private support follow-up"],
    popular: true,
    buttonText: "Join 8-Week Reset",
    buttonLink: "/online-coaching",
  },
  {
    name: "Sweat with Scott Daily",
    price: "$39",
    period: "per month",
    description: "Daily boxing drills, conditioning, and ongoing coaching accountability",
    features: [
      "Daily follow-along training sessions",
      "Technique and footwork drills",
      "Monthly program updates",
      "Progress tracking inside your dashboard",
      "Cancel anytime",
    ],
    popular: false,
  ...
  },
  {
    ...
    price: "$150",
    period: "per month",
    description: "In-person classes and facility access",
    features: [
      "Unlimited classes",
      "Priority booking",
    ...
    popular: false,
    buttonText: "Join Gym Membership",
  ...
  return (
    <div className="w-full">
      <div className="text-center mb-12">
        <h2 className="cave-section-title mb-4">Programs & Memberships</h2>
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Start with the 8-week reset, then continue with daily coaching for long-term results.
        </p>
      </div>
